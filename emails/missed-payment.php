...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
    <tbody><tr>
        <td valign="top" style="padding:0 9px"><span class="im">
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                <tbody><tr>
                    <td valign="top">
                        ...
                        <img alt="Half of GreekBank Logo" src="<?php echo home_url('/wp-content/uploads/2015/08/Side-Logo-Half-e1438818836324.png'); ?>" width="33" style="max-width:33px;border:0;min-height:auto;outline:none;text-decoration:none;vertical-align:bottom" class="CToWUd">
            ...
            </span><table align="right" border="0" cellpadding="0" cellspacing="0" width="396" style="border-collapse:collapse;width:90%">
                <tbody><tr>
                    <td style="color:#606060;font-family:Helvetica;font-size:15px;line-height:150%;text-align:left">
                        <h1 style="font-size:60px;display:block;margin:0;padding:0;font-family:Helvetica;font-style:normal;font-weight:bold;line-height:125%;letter-spacing:-1px;text-align:left;color:#606060!important"><span style="color:#00aced">Missed<br>Payment</span></h1>
...
<p style="margin:1em 0;color:#606060;font-family:Helvetica;font-size:15px;line-height:150%;text-align:left">Oops, it looks like you recently missed a payment. &nbsp;You owe <strong>${missed_payment}.</strong> &nbsp;This payment is <strong>{days_overdue}</strong> day(s) past the <strong>{past_due_date}</strong> due date.</p>
    ...
    <tbody>
        <tr>
            <td style="padding:0px 18px 18px">
    ...
    <tbody>
        <tr>
            <td style="padding-top:0;padding-right:18px;padding-bottom:18px;padding-left:18px" valign="top" align="center">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate!important;border:2px solid #707070;border-radius:5px;background-color:#00aced">
                    <tbody>
                        <tr>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse">
                    <tbody><tr>
                        ...
                        <td valign="top" style="padding-top:9px;padding-right:18px;padding-bottom:9px;padding-left:18px;color:#606060;font-family:Helvetica;font-size:15px;line-height:150%;text-align:left">
                            ...
                            <p style="margin:1em 0;color:#606060;font-family:Helvetica;font-size:15px;line-height:150%;text-align:left">You may be subject to fines and potentially sent to collections, with your treasurer's consent for the delay in payment.</p>
            ...
            <td valign="top">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse">
                    <tbody><tr>
                        ...
                        <td valign="top" style="padding-top:9px;padding-right:18px;padding-bottom:9px;padding-left:18px;color:#606060;font-family:Helvetica;font-size:11px;line-height:125%;text-align:center">

                            <em>Copyright © {current_year} GreekBank, All rights reserved.</em>
